...
<p align="center">
  <img alt="release" src="https://img.shields.io/badge/release-v0.23.1-2DA44E">
...
zipax v0.23.1 polishes the new Tauri updater flow. Manual checks now show an inline "up to date" hint, update downloads stay inside the app UI, and the GitHub Actions release workflow passes the required updater signing secrets.
...
zipax v0.23.1 继续打磨新的 Tauri 自动更新流程。手动检查已是最新版本时会在按钮旁显示提示，更新下载留在应用内界面，同时修复了 GitHub Actions 发布流程中 updater 签名 secret 未传入的问题。
