...
<p align="center">
  <img alt="release" src="https://img.shields.io/badge/release-v0.25.4-2DA44E">
...
zipax v0.25.4 is a patch release fixing Windows autostart and Linux packaging issues.
...
zipax v0.25.4 是补丁版本，修复 Windows 开机自启动路径和 Linux 打包依赖问题。
